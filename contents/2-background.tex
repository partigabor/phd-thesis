...
It cannot be better illustrated than the following quotations. 
...
There are fallacies not only regarding the names but the content regarding the nature and history of the spices as well.
