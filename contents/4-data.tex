...
\begin{multicols}{2}
\begin{enumerate}
    \item \textbf{allspice} (\taxon{Pimenta dioica}) \quad \hfill \pageref{sec:allspice}
    \item anise (\taxon{Pimpinella anisum}) %\quad \hfill \pageref{sec:anise}
    \item \textbf{asafoetida} (\taxon{Ferula assa-foetida} et al.) \quad \hfill \pageref{sec:asafoetida}
    ...
    \item \textbf{cardamom} (\taxon{Elettaria cardamomum}) \quad \hfill \pageref{sec:cardamom}
    \item \textbf{cassia} (\taxon{Cinnamomum cassia} et al.) \quad \hfill \pageref{sec:cassia}
    \item chile (\taxon{Capsicum annuum} et al.) %\quad \hfill \pageref{sec:chile}
    \item \textbf{cinnamon} (\taxon{Cinnamomum verum}) \quad \hfill \pageref{sec:cinnamon}
    ...
    \item \textbf{long pepper} (\taxon{Piper longum}) \quad \hfill \pageref{sec:long_pepper}
	...
	\item \textbf{pepper} (\taxon{Piper nigrum}) \quad \hfill \pageref{sec:pepper}
    ...
    \item \textbf{turmeric} (\taxon{Curcuma longa}) \quad \hfill \pageref{sec:turmeric}
