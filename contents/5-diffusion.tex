...
The fact that English has many loanwords in the spice domain is not surprising if we understand that all of these aromatic product are exotic, they are not from anywhere near England, or the Saxon homeland. As for Arabic, we know from history that all materials from Asia passed through the Arabian Peninsula, and the names of many products with origins in West Asia predate Arabic, hence the high number of loanwords. 

%loanwords in Arabic

%loanwords in Chinese

% The earliest attested spice names are 
