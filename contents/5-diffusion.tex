...
% \begin{figure}[ht!]
%     \includegraphics[width=\linewidth]{imgs/plots/spices_map_ne.pdf}
%     \caption{The approximate geographical origins of the spices in this thesis.}
%     \label{fig:spices_map_ne}
% \end{figure}
...
\begin{figure}[ht!]
    \includegraphics[width=\linewidth]{imgs/plots/loanwords_pie.pdf}
    \caption{}
    \label{fig:loanwords_pie}
\end{figure}
...
\begin{table}[]
    ...
    \toprule
    \textbf{\#} & \textbf{English} & \textbf{borr.} & \textbf{Arabic}  & \textbf{borr.} & \textbf{Chinese} & \textbf{borr.} \\ \midrule
    1           & allspice         & -           & fulful ifranjī   & -           & duōxiāngguǒ      & +           \\
    2           & anise            & +           & anīsūn           & +           & huíqín           & -           \\
    3           & asafoetida       & +           & ḥiltīt           & +           & āwèi             & +           \\
    4           & caraway          & +           & karāwiyā         & +           & gě​lǚ​zi         & +           \\
