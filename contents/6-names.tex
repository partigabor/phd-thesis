...
\lettrine[lines=\iniciale]{\textcolor{\accentcolor}{N}}{ow} that the detailed introduction of the spices is complete, let us look at the the analysis and findings. As a result of the data collection set forth in \cref{ch:data}, the database now contains 369 spice names. Of these, 159 are in English, 88 are in Arabic, and 122 are in Chinese; \cref{fig:languages_pie} shows this distribution. The total number is the accumulation of the lengthy process of carefully compiling the nomenclature for the set of spices as defined at the beginning of the thesis, which consists of 25 different spices. The data collection was detailed in \cref{sec:data_collection}, and this chapter aims to showcase the many ways we can interpret, analyze, and visualize the data.
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\linewidth]{imgs/plots/ids_trio_h.pdf}
	\caption[]{}
	\label{fig:a}
\end{figure}
