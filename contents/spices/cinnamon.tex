...
\begin{figure}[!ht]
	\vspace{-4ex}
	\centering
	\subfloat[stick]{\includegraphics[width=0.31\linewidth]{imgs/spices/cassia-1.jpg}}
	\hfill
	\subfloat[bud (dried unripe fruit)]{\includegraphics[width=0.31\linewidth]{imgs/spices/cassia-2.jpg}}
	\hfill
	\subfloat[bud]{\includegraphics[width=0.31\linewidth]{imgs/spices/cassia-3.jpg}}
...
% \amarginpar{French \textit{baies de cannelier}}
...
\textit{dārṣīnī}\amarginpar{darsini} or \ar{دار صيني} 
...
\textit{salīkha}\amarginpar{salikha}\footnote{From \textit{salakha} `to pull off, strip off; skin, flay', after the method of peeling off a tree's skin; \url{http://www.semiticroots.net/index.php?r=root/view&id=387}}, a term that has been associated with cassia (\taxon{C. cassia}) from early texts until today. 
