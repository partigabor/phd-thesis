...
% \toprule
% \multicolumn{1}{@{}l}{\textbf{Chinese}} & \multicolumn{1}{l@{}}{\textbf{gloss}} \\
% \midrule
% duōxiāngguǒ & many-fragrant-fruit \\
% zhòngxiāngzǐ & numerous-fragrant-seed \\
% yámǎijiā hújiāo & Jamaica [black] pepper \\
% \bottomrule
% \end{tabular}
% \end{table}
...
% \begin{tabular}{@{}>{\itshape}ll@{}}
% \toprule
% \multicolumn{1}{@{}l}{\textbf{Arabic}} & \multicolumn{1}{l@{}}{\textbf{gloss}} \\
% \midrule
% filfil ifranjī & European pepper \\
% fifil ḥulw & sweet pepper \\
% bahār ḥulw & sweet spice \\
% \bottomrule
% \end{tabular}
% \end{table}
