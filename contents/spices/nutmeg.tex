...
\input{envs/etymbox_nutmeg}

\input{envs/names_nutmeg_en}

\subsubsection{Arabic}

\input{envs/names_nutmeg_ar}

\subsubsection{Chinese}

\input{envs/names_nutmeg_zh}

\subsubsection{Summary}

\input{envs/names_nutmeg}
...
\textbf{Chinese}: \tc{肉荳蔻皮} \textit{ròudòukòupí}.
