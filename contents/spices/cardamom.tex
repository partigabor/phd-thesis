...
In Arabic, cardamom is known by many different names varying from dialect to dialect, but the most common to come across in both modern and historical dictionaries is \amarginpar{hal} \ar{هال} \textit{hāl} or\ar{هيل} \textit{hayl}.
