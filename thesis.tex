...
\newcommand{\accentcolor}{OliveGreen}
...
% \babelprovide[import=zh-hans, onchar=fonts ids]{chinese} % Or zh-hans for Simplified Chinese, zh-hant for traditional
...
% \babelfont[chinese]{rm}[Renderer=HarfBuzz]{Noto Serif CJK tc}
...
% Can also be solved with kotex and Noto Serif CJK (Static) OTF font collections (https://github.com/googlefonts/noto-cjk/tree/main/Serif/OTC) but not enough memory
...
\newcommand{\vi}[1]{#1}
\newcommand{\zh}[1]{\simpchinesefont{#1}\rmfamily}
% \newcommand{\zh}[1]{#1}
...
\DTMsavedate{rev}{2022-12-27}  % date of revision
\date{\DTMusedate{ini}}
