...
Mandarin Chinese {\tc{豆蔻}} \textit{dòukòu} \textsc{mc} MC /dəuH həuH/ `cardamom' [bean-cardamom], compound of 豆 `bean(-like)' + \tc{蔻} `many; profusion' (BCGM); or phono-semantic matching (confused with nutmeg at first), ca. 863
<\textss{?} Middle Chinese {多骨} \textit{duōgǔ} \textsc{mc} MC /tɑ kuət/ `round cardamom'
