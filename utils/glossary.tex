...
\newglossaryentry{DMM}{type=primary, name={De Materia Medica},description={[On Medical Materials] by Pedanius Dioscorides, \nth{1} c. \textsc{ad}}}
...
\newglossaryentry{Shuowen}{type=primary, name=Shuowen Jiezi, description={說文解字 [Discussing Writing and Explaining Characters] 100 \textsc{ad}}}

\newglossaryentry{Liji}{type=primary, name=Liji, description={禮記 [The Book of Rites] Warring States period, 475--221 \textsc{bc}}}

\newglossaryentry{Bowuzhi}{type=primary, name=Bowuzhi, description={博物志 [Records of Diverse Matters] by Zhang Hua, c. 290 \textsc{ad}}}
...
\newglossaryentry{Shennong}{type=primary, name=Shennong Bencaojing, description={神農本草經 [Shennong's Classic Herbal] ca. 200 \textsc{ad}}}
...
\newglossaryentry{Shijing}{type=primary,name={Shijing},description={詩經 [Classic of Poetry/Book of Odes] 11--\nth{7} \textsc{bc}}}

\newglossaryentry{Tongdian}{type=primary,name={Tongdian},description={通典 [Comprehensive Statutes] by Du You, Tang, 801}}

\newglossaryentry{Sushruta}{type=primary, name={Suśrutasaṃhitā},description={{\devanagarifont सुश्रुतसंहिता} [Suśruta's Compendium] ca. 600 \textsc{ad}}}
