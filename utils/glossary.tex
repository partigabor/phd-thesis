% Glossary
\newglossaryentry{wanderwort}{name=Wanderwort,plural={Wanderwörter},description={a word borrowed from one language to another across a broad geographical area often as a result of trade or adoption of newly introduced items or cultural practices\footcite[Wanderwort]{mw}}}
...
\newglossaryentry{bencao}{name=bencao, description={the Chinese term for \textit{materia medica}, works that record the sources and applications of medicinal substances (\traditionalchinesefont{本草})\footcite[]{zhao_concise_2018}}}
...
\newglossaryentry{Columbian}{name={Columbian exchange},description={the transfer of plants, animals, and diseases between the Old World and the New World after contact}}
...
\newacronym{EI2}{EI2}{Encyclopedia of Islam, Second Edition}
\newacronym{EIr}{EIr}{Encyclopedia Iranica}
\newacronym{EJ}{EJ}{Encyclopedia Judaica}
\newacronym{EQ}{EQ}{Encyclopedia of the Qur'ān }
\newacronym{FAOSTAT}{FAOSTAT}{UN Food and Agriculture Organization Statistical Database}
...
% Primary Sources
\newglossaryentry{Periplus}{type=primary, name={Periplus Maris Erythraei},description={[Periplus of the Erythraean Sea] first c. \AD{}}}

\newglossaryentry{DMM}{type=primary, name={De Materia Medica},description={[On Medical Materials] by Pedanius Dioscorides, first c. \AD{}}}
...
\newglossaryentry{Mafatih}{type=primary, name={Mafātīḥ al-ʿUlūm}, description={{\arabicfont{مفاتيح العلوم}} [Keys to the Sciences] by Muḥammad ibn al-ʿAbbās Abū Bakr al-Khwārizmī, 975--997}}

\newglossaryentry{Ayn}{type=primary,name={Kitāb Al-ʿAyn},description={{\arabicfont{كتاب العين}} [The Source] by al-Khalīl b. Aḥmad al-Farāhīdī, ca. 786}}
...
\newglossaryentry{QTS}{type=primary, name=Quan Tangshi, description={全唐詩 [Complete Tang Poems] poetry collection, 1705}}

\newglossaryentry{Guangyun}{type=primary, name=Guangyun, description={廣韻 [Broad Rhymes] rhyme dictionary, 1008}}
...
\newglossaryentry{Zhouli}{type=primary, name=Zhouli, description={周禮 [Rites of Zhou] Warring States, second c. \BC{}}}

\newglossaryentry{Hou Hanshu}{type=primary, name=Hou Hanshu, description={後漢書 [Book of the Later Han] fifth c. \AD{}}}

\newglossaryentry{Shennong}{type=primary, name=Shennong Bencaojing, description={神農本草經 [Shennong's Classic Herbal] ca. 200 \AD{}}}

\newglossaryentry{Bencao}{type=primary,name=Bencao Gangmu,description={本草綱目 [Compendium of Materia Medica] by Li Shizhen, 1578}}

\newglossaryentry{Youyang}{type=primary,name={Youyang Zazu},description={酉陽雜俎 [Miscellaneous Morsels from Youyang] by Duan Chengsi, ninth c.}}

\newglossaryentry{Nanfang}{type=primary,name={Nanfang Caomu Zhuang},description={南方草木狀 [Plants of the Southern Regions] fourth c. \AD{}}}
...
\newglossaryentry{Xinxiu}{type=primary,name={Xinxiu Bencao},description={新修本草 [Newly Revised Materia Medica] Tang, 659}}

\newglossaryentry{Shijing}{type=primary,name={Shijing},description={詩經 [Classic of Poetry/Book of Odes] eleventh--seventh \BC{}}}

\newglossaryentry{Tongdian}{type=primary,name={Tongdian},description={通典 [Comprehensive Statutes] by Du You, Tang, 801}}

\newglossaryentry{Sushruta}{type=primary, name={Suśrutasaṃhitā},description={{\devanagarifont सुश्रुतसंहिता} [Suśruta's Compendium] ca. 600 \AD{}}}
