...
\newglossaryentry{taxon}{name=taxon,plural={taxa},description={taxonomic group or unit, esp. when its rank in the taxonomic hierarchy is not specified; (Botany)}} %OED
...
\newglossaryentry{Lisan}{type=primary, name=Lisan al-Arab, description={{\arabicfont {لسان العرب}} [Tongue of the Arabs] (1290) - dictionary}}
...
\newglossaryentry{Youyang}{type=primary,name={Youyang Zazu},description={酉陽雜俎 [Miscellaneous Morsels from Youyang] --- \nth{9} c.}}
...
\newglossaryentry{Qanun}{type=primary,name={al-Qānūn fī al-Ṭibb},description={{\arabicfont{القانون في الطب}} [The Canon of Medicine] by Ibn Sīnā/Avicenna --- 1025.}}
